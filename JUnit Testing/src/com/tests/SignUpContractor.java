...
public class SignUpContractor {
  ...
  @Test
  public void testSignUpContractor() throws Exception {
    ...
    driver.findElement(By.name("name")).sendKeys("SELENIUMTESTCONT");
    Thread.sleep(2000);
    driver.findElement(By.name("address")).clear();
    driver.findElement(By.name("address")).sendKeys("4321 Testing Boulevard");
    Thread.sleep(2000);
    driver.findElement(By.name("phone")).clear();
    driver.findElement(By.name("phone")).sendKeys("321-321-4321");
    Thread.sleep(2000);
    ...
    Thread.sleep(2000);
    driver.findElement(By.id("contractor")).click();
    Thread.sleep(2000);
